...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/saptaparno-roy-sen-8335a1210/)
[![Email](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:roy.saptaparnos10@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Saptaparno)
[![Valura](https://img.shields.io/badge/Live-Valura-58A6FF?style=for-the-badge)](https://app.valura.ai)
[![KnoWhy](https://img.shields.io/badge/Live-KnoWhy-7C3AED?style=for-the-badge)](https://app.knowhy.co.in)
[![Synqer](https://img.shields.io/badge/Live-Synqer-22C55E?style=for-the-badge)](https://crm.synqer.io)
[![LocalDoctors](https://img.shields.io/badge/Live-LocalDoctors-0EA5E9?style=for-the-badge)](https://localdoctors.net)
...
[![Terminal](https://readme-typing-svg.demolab.com?font=Fira+Code&size=13&duration=700&pause=350&color=00FF41&background=000000&multiline=true&center=false&vCenter=false&width=580&height=420&repeat=true&lines=matrix:$+./init_sequence.sh;[OK]+vectorstore+connected;[OK]+agents+orchestrated;matrix:$+pip+install+agno+langgraph+fastapi;Successfully+installed+agno+langgraph+fastapi;matrix:$+python+embed_docs.py+--chunk+512;847+documents+indexed+to+pgvector;matrix:$+docker+compose+up+-d;fastapi+++postgres+++redis+++online;matrix:$+redis-cli+ping;PONG;matrix:$+curl+-s+localhost:8000/health;status:ok+agents:4+rag:true;matrix:$+pytest+tests/+-q;42+passed+in+3.21s;matrix:$+kubectl+get+pods;agent-worker-0+++1/1+++Running;matrix:$+hf+whoami;Logged+in+as+Saptaparno;matrix:$+tail+-n+1+logs/agent.log;[INFO]+orchestrator:+task+complete;matrix:$+git+push+origin+main;Everything+up-to-date)](https://github.com/Saptaparno)
...
Focused on **Agentic AI**, **Natural Language Processing**, and **Computer Vision** architectures to ship autonomous, intelligent systems.

```js
const profile = {
  name: "Saptaparno Roy Sen",
  role: "AI Engineer & SaaS Developer",
  location: "Kolkata, India",
  focus: ["Agentic AI", "NLP", "Computer Vision"],
  education: [
    "IIT Madras — B.S. Data Science & Applications",
    "Amity University — B.Tech. Artificial Intelligence",
  ],
  askMeAbout: ["RAG", "Multi-agent systems", "Full-stack SaaS"],
  contact: {
    linkedin: "saptaparno-roy-sen-8335a1210",
    email: "roy.saptaparnos10@gmail.com",
  },
};
```
...
[![Valura](https://img.shields.io/badge/Valura-app.valura.ai-58A6FF?style=flat-square)](https://app.valura.ai)
[![KnoWhy](https://img.shields.io/badge/KnoWhy-app.knowhy.co.in-7C3AED?style=flat-square)](https://app.knowhy.co.in)
[![Synqer](https://img.shields.io/badge/Synqer-crm.synqer.io-22C55E?style=flat-square)](https://crm.synqer.io)
[![LocalDoctors](https://img.shields.io/badge/LocalDoctors-localdoctors.net-0EA5E9?style=flat-square)](https://localdoctors.net)
[![BRMH](https://img.shields.io/badge/BRMH-brmh.ai-F97316?style=flat-square)](https://brmh.ai)
[![IndieRise](https://img.shields.io/badge/IndieRise-theindierise.com-EC4899?style=flat-square)](https://theindierise.com)
...
[![My Skills](https://skillicons.dev/icons?i=python,java,cpp,typescript,fastapi,nodejs,express,docker,gcp,aws,vercel,postgres,mongodb,mysql,redis,git,github,pytorch,tensorflow,openai,huggingface&perline=11)](https://skillicons.dev)
...
**UPI ID:** `6289986436@upi`

Pay using your preferred app:

[![Google Pay](https://img.shields.io/badge/Google%20Pay-4285F4?style=for-the-badge&logo=googlepay&logoColor=white)](upi://pay?pa=6289986436@upi&pn=Saptaparno%20Roy%20Sen&cu=INR)
[![PhonePe](https://img.shields.io/badge/PhonePe-5F259F?style=for-the-badge&logo=phonepe&logoColor=white)](upi://pay?pa=6289986436@upi&pn=Saptaparno%20Roy%20Sen&cu=INR)
[![Paytm](https://img.shields.io/badge/Paytm-002970?style=for-the-badge&logo=paytm&logoColor=white)](upi://pay?pa=6289986436@upi&pn=Saptaparno%20Roy%20Sen&cu=INR)
[![BHIM](https://img.shields.io/badge/BHIM%20UPI-00BAF2?style=for-the-badge&logo=bhim&logoColor=white)](upi://pay?pa=6289986436@upi&pn=Saptaparno%20Roy%20Sen&cu=INR)
